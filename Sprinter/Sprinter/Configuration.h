...
#define _AXIS_STEP_PER_UNIT {124, 124, 3200/1.25,700}
...
#define _MAX_FEEDRATE {4000, 4000, 2, 45}       // (mm/sec)    
#define _HOMING_FEEDRATE {4000,1500,120}      // (mm/min) !!
